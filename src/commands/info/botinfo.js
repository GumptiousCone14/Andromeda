...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches Andromeda\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Andromeda\'s Bot Information')
      .setDescription(oneLine`
        Andromeda is an open source, fully customizable Discord bot that is constantly growing.
      ...
      .setImage('https://raw.githubusercontent.com/sabattle/AndromedaBot/develop/data/images/Andromeda_Title.png')
