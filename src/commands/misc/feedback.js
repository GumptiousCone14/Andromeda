...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the Andromeda Support Server\'s feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love Andromeda!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Andromeda Support Server](https://discord.gg/pnYVdut) to further discuss your feedback.
      `) 
